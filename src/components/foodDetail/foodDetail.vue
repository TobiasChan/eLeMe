    ...
    <div class="foodDetail" v-show="showFlag" ref="foodDetail">
      <div class="food-content">
        ...
        <div class="info" v-show="food.info">
          ...
          <p class="text">&nbsp&nbsp&nbsp&nbsp{{food.info}}</p>
        </div>
        <split></split>
        <div class="rating">
          <h1 class="title">商品评价</h1>
          <ratingSelect :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings" @ratingType="select" @toggleContent="toggleContent"></ratingSelect>
          <div class="rating-wrapper">
            ...
            <div class="no-rating" v-show="!food.ratings || !food.ratings.length">暂无评价/(ㄒoㄒ)/~~</div>
          </div>
        </div>
      </div>
    </div>
